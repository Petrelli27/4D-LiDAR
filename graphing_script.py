...
folder_path = 'full_results_dir/full_results_1000_ml_3class'
...
for filename in os.listdir(folder_path):
    if filename.endswith('.csv'):  # Check if the file is a CSV
        ...
        df = df.head(200)  # Keep only the first 200 samples
...
combined_df.to_csv('combined_output_ml_3class_200.csv', index=False)
